...
function multiply(a, b) {
  var z=a*b
  var strings='The product of ' + a + ' and ' + b + ' is ' + z + '.'
  // eslint-disable-line
  return[z,strings]
...
function sumArray(sumArr) {
  ...
  let twoNumsSum = sum(num1, num2)[0];
  let finalSum = sum(twoNumsSum, num3)[0];
...
function multiplyArray(multArr) {
  ...
  let twoNumsMult = multiply(num1, num2)[0];
  let finalMult = multiply(twoNumsMult, num3)[0];
